...
public:
 ...
 Employee(string n,int a,string g,string b,string r,string na,string i,string q,string co):Person(n,i,a,g,b,r,na,co){
...
public:
    Faculty(string n,int a,string g,string b,string r,string na,string i,string q,string f,float s,string co):Employee(n,a,g,b,r,na,i,q,s,co),Person(n,i,a,g,b,r,na,co)
    {
        fn =f;
    }
void showinfo(){
...
public:
    Officer(string n,int a,string g,string b,string r,string na,string i,string q,string d,string o,float s,string co):Employee(n,a,g,b,r,na,i,q,s,co),Person(n,i,a,g,b,r,na,co)
    {
        dn =d;
        orn=o;
    }
...
public:
ScholarshipStudent(string n,int a,string g,string b,string r,string na,string i,float c,string sh,string am,string co):Student(n,a,g,b,r,na,i,c,sh,co),Person(n,i,a,g,b,r,na,co)
{
    ams=am;
}
void showinfo(){
...
class TA : public Student,public Employee  {
    private:
    string year;//which year is he studying?
  

public:
TA(string n,int a,string g,string b,string r,string na,string i,string y,float c,string sh,string q,string co):Student(n,a,g,b,r,na,i,c,sh,co),Employee(n,a,g,b,r,na,i,q,co),Person(n,i,a,g,b,r,na,co)
{
 ...
 void showinfo(){
       cout<<"  "<<endl;
       cout<<"__________TA__________"<<endl;
       cout<<"Name                  : "<<name<<endl;
       cout<<"Identity              : "<<id<<endl;
       cout<<"CGPSA                 : "<<cgpa<<endl;
       cout<<"Shift                 : "<<shift<<endl;
       cout<<"Which year            : "<<year<<endl;
       cout<<"Age                   : "<<ag<<"-years"<<endl;
       cout<<"Gender                : "<<ge<<endl;
       cout<<"Qualification         : "<<qu<<endl;
       cout<<"Blood group           : "<<bg<<endl;
...
int main (){
    ...
    p6.showinfo();
    TA p7("Jonayat",20,"male","A+","Islam","Bangladeshi","34-43","4th year final semester",4.00,"morning","Studying in CSE","+88013422313");
    p7.showinfo();
    return 0;
}
